...
function movie_command() {
    ...
    //sends an api request to the omdb website that specifies the random_text variable that the user entered.  Also begins a function
    request('http://www.omdbapi.com/?apikey=trilogy&t='+random_text, function (error, response, body) {
